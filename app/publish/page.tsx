...
export default function PublishPage() {
  const { pages, folders, globalComponents, tokens, collections, entries } = useBuilderStore();
  ...
  const handleExport = async () => {
    ...
    try {
      const zip = new JSZip();
      const siteCode = generateSiteCode(pages, folders, globalComponents, tokens, exportFormat, collections, entries);
